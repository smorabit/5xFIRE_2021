...
p1 <- VlnPlot(subset(seurat_obj, class=='IMM'), features='Csf1r', group.by='DX', pt.size=0) + scale_fill_manual(values=sample_color.scheme) +
stat_summary(fun.data='mean_cl_boot', color='black') +
stat_compare_means(method='wilcox', comparisons=comparisons, label='p.signif') +
xlab('') + NoLegend() + ylim(c(-0.1,4.75))

pdf(paste0(fig_dir, 'vlnplot_Csf1r_DX.pdf'), width=4, height=4)
p1
dev.off()
